...
public class D06P14 {
    public static void main(String[] args) {
        ...
        System.out.println("Number of keys in the hashtable: " + employeeHashtable.size());
        ...
        // Add employee data from Hashtable to another collection (HashMap) with some existing data
        Map<Integer, Employee> specificCollection = new HashMap<>();
        specificCollection.put(2001, new Employee(2001, "Samuel", "Marketing", "Marketing Manager"));
        specificCollection.put(2002, new Employee(2002, "Sophia", "Finance", "Financial Analyst"));
        
        specificCollection.putAll(employeeHashtable);

        System.out.println("All employees in the specific collection:");
