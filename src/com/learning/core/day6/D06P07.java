...
public class D06P07
{
    public static void main(String[] args) {
        ...
        Map.Entry<Car, String> leastValueEntry = carMap.firstEntry();
        Map.Entry<Car, String> greatestValueEntry = carMap.lastEntry();

        System.out.println( greatestValueEntry.getKey());
        System.out.println( leastValueEntry.getKey());
